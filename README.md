...
* `skopt` / `scikit-optimize` - one maintainer, a core dev of scikit-learn, is alleged
  to have **shut down the project
...
* when writing to single email given in readme ([screenshot of pointer until 2024-03](https://github.com/ELTE-IAI/sk-os-takeovers/blob/main/re-pyportfolioopt/pyportfolioopt-single-email-2024-03-12.jpg)), [maintainer points to skfolio](https://github.com/ELTE-IAI/sk-os-takeovers/blob/main/re-pyportfolioopt/skfolio-email1-2024-01-24.jpg)
...
* according to other maintainer, done by betatim (Tim Head) without communicating with other maintainers,
